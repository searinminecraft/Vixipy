...
* `PYXIV_UGOIRA_SERVER_NEEDS_DATE` (default: 0): If the preview server can use the creation date
...
| vx.laincorp.tech | https://vx.laincorp.tech | [yes](http://vx.lainyubrp2aabmxhepbttfdbl53dct2inqifs42buvpf6w44uiitbeqd.onion) | no | no | DE | |
